...
const data = [
  {
    ...
    description: (
      <>
        <div className="author-info">
          <Title level={5}>With Ice creem</Title>
          {/* <p>With Tutti Frutti</p> */}
        </div>
      </>
    ),
    ...
    type: (
      <>
        <Button danger type="primary" className="tag-primary">
         Non-Veg
        </Button>
      </>
    ),
...

  {
    ...
    description: (
      <>
        <div className="author-info">
          <Title level={5}>With Tutti Frutti</Title>
          {/* <p>With Ice creem</p> */}
        </div>
      </>
    ),
    ...
    type: (
      <>
        <Button className="tag-badge" style={{backgroundColor:'green'}} >ONLINE</Button>
      </>
    ),
   price: (
      <>
