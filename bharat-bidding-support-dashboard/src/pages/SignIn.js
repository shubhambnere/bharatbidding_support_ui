...
import { Layout, Row, Col, Typography, Form, Input, Button, Tabs, message, Select } from "antd";
// import {
//   DribbbleOutlined,
//   TwitterOutlined,
//   InstagramOutlined,
...
// import GoogleSignIn from "../assets/images/googleloginbackground.jpg";
...
const SignIn = () => {
  ...
  const onEmailPasswordSubmit = (values) => {
    console.log("Email/Password Form Values:", values);
  };
        ...
        <Content className="signin">
          <Row gutter={[24, 0]} justify="space-around">
            <Col xs={{ span: 24 }} lg={{ span: 6, offset: 2 }} md={{ span: 12 }}>
              <Title className="mb-15" style={{ fontSize: '28px' }}  >Sign In</Title>
              <Tabs
                centered
                activeKey={loginMethod}
                onChange={(key) => setLoginMethod(key)}
              >
                ...
                <Tabs.TabPane key="Phone" tab="Phone/OTP">
                  <Form
                ...
                <Tabs.TabPane key="mobile-otp" tab="Mobile & Password">
                  <Form
                    onFinish={handleOTPSubmit}
                    layout="vertical"
                    className="row-col"
                ...
                {/* <Tabs.TabPane key="gmail" tab="Gmail" style={{ background: '#f0f0f0', padding: '20px' }}>
  <div style={{ marginBottom: '20px' }}>

    <img src={GoogleSignIn} alt="GoogleSignIn" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <GoogleLogin
  ...
  />
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignContent: 'end', alignItems: 'center', marginBottom: '10px' }} className="font-semibold text-muted text-center">
                <GoogleLogin
                  clientId="YOUR_CLIENT_ID_FROM_GOOGLE_DEVELOPER_CONSOLE"
                  buttonText="Login with Google"
                  onSuccess={responseGoogle}
                  ...
                  cookiePolicy={'single_host_origin'}
                />
                <Link to="/forgotPassword" className="font-bold text-dark" >
                  Forgot Password
                </Link>
              </div>
